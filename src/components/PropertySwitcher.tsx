...
export function PropertySwitcher() {
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {open && (
        <div className="absolute left-0 mt-1 w-72 max-w-[calc(100vw-1rem)] max-h-80 overflow-y-auto bg-white border border-black/15 rounded-md shadow-md z-40 text-sm">
          {error && (
